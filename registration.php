...
<main>
   ...
   <form id="registrationForm" action="registrationProcess.php" method="post" >
            ...
            <div class="form-group last mb-4">
              ...
              <input type="password" id="newPassword" size="50" tabindex="2" placeholder="New Password" title="8 or more characters, at least one uppercase, lowercase and number" accesskey="n" name="newPassword"  minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" tabindex="4" required>
              <!--Password (UpperCase, LowerCase, Number/SpecialChar and min 8 Chars)--> 
			  <label for="confirmPassword"></label>
              <input type="password" id="confirmPassword" size="50" tabindex="2" placeholder="Confirm Password" title="8 or more characters, at least one uppercase, lowercase and number" accesskey="c" name="confirmPassword" minlength="8" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="form-control" tabindex="5" required>
            </div>
            <input type="submit" value="Register" name="submit" id="rsubmit" class="btn text-white btn-block btn-primary" tabindex="6" class="form-control" accesskey="s">
          </form>
</main>
<!-- End of main -->
